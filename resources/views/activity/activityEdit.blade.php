                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-8 col-lg-offset-2">
                                ...
                                <select class="select2 select2-multiple required" name="activitySkills[]" id="activitySkills" multiple="multiple" multiple data-placeholder="">
                                    ...
                                    @if($skill->name == "Environment")
                                    <option value="Environment" selected="">Environment</option>
                                    @else
                                    <option value="Environment">Environment</option>
                                    @endif
                                    @if($skill->name == "Livelihood")
                                    <option value="Livelihood" selected="">Livelihood</option>
                                    @else
                                    <option value="Livelihood">Livelihood</option>
                                    @endif
                                    @if($skill->name == "Education")
                                    <option value="Education" selected="">Education</option>
                                    @else
                                    <option value="Education">Education</option>
                                    @endif
                                    @if($skill->name == "Charity")

                                    <option value="Charity" selected="">Charity</option>
                                    @else
                                    <option value="Charity">Charity</option>
                                    @endif
                                    @if($skill->name == "Sports")
                                    <option value="Sports" selected="">Sports</option>
                                    @else
                                    <option value="Sports">Sports</option>
                                    @endif
                                    @if($skill->name == "Culinary")
                                    <option value="Culinary" selected="">Culinary</option>
                                    @else
                                    ...
                                    @endif
                                    @if($skill->name == "Free for all")

                                    <option value="Free for all" selected="">Free for all</option>
                                    @else
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-8 col-lg-offset-2" id="mapWindow">
                                ...
                                <div id="locationField">
                                    <input name="activityLocation" type="text" id="pac-input" value="{{ $activity->location }}" class="required form-control" placeholder="">
                                </div>
                            </div>
