<!-- top header -->
      <div class="header navbar">
          ...
          <li class="navbar-form search-form hide">
            ...
            <div class="search-predict hide">
              ...
              <ul class="predictive-list">
                <li>
                  <a class="avatar" href="#">
                    <img src="{{ asset('reactorAssets/images/face1.jpg') }}" class="img-circle" alt="">
                    <span>Tammy Carpenter</span>
                  </a>
                </li>
                <li>
                  <a class="avatar" href="#">
                    <img src="{{ asset('reactorAssets/images/face2.jpg') }}" class="img-circle" alt="">
                    <span>Catherine Moreno</span>
                  </a>
                </li>
                <li>
                  <a class="avatar" href="#">
                    <img src="{{ asset('reactorAssets/images/face3.jpg') }}" class="img-circle" alt="">
                    <span>Diana Robertson</span>
                  </a>
                </li>
                <li>
                  <a class="avatar" href="#">
                    <img src="{{ asset('reactorAssets/images/face4.jpg') }}" class="img-circle" alt="">
              ...
              <ul class="predictive-list">
                <li>
                  <a class="avatar" href="#">
                    <img src="{{ asset('reactorAssets/images/unsplash/img2.jpeg') }}" class="img-rounded" alt="">
        ...
        <ul class="nav navbar-nav navbar-right hidden-xs">
                ...
                <ul class="notifications-list">
                  ...
                  <li>
                    <a href="javascript:;">
                      ...
                      <img src="{{ asset('reactorAssets/images/face3.jpg') }}" class="avatar img-circle" alt="">
                      </span>
          ...
          <li>
            <a href="javascript:;" class="ripple" data-toggle="dropdown">
              <img src="{{ asset('reactorAssets/images/avatar.jpg') }}" class="header-avatar img-circle" alt="user" title="user">
