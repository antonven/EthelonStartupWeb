...
class Activity extends Model
{
    ...
    protected $fillable=['activity_id','foundation_id','name','image_url','imageQr_url','description','location','start_time','end_time','startDate','group', 'long', 'lat', 'points_equivalent','status','created_at','endDate','registration_deadline','contact','contactperson','volunteersNeeded'
    ];
